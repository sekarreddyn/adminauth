...
import { Form, Button, Row, Col, Table, Divider, Icon, Menu, Dropdown } from 'antd';
	...
	return (
		<Form onSubmit={validateInput}>
			...
			<Row className="d-flex align-items-center">
				<Col span={8}>
					<h3 className="session-title">Scenario 1<span className="mt-2">Jan 2019 - Jan 2020</span></h3>
				</Col>
				<Col span={4} className="text-center border-right">
					<h5 className="text-muted mb-3">MEDIA SPEND</h5>
					<b className="text-success">107, 165, 670 <span className="session-count bg-success"><Icon type="caret-up" /> 10%</span></b>
				</Col>
				<Col span={4} className="text-center border-right">
					<h5 className="text-muted mb-3">MEDIA VOLUME</h5>
					<b className="text-danger">107, 165, 670 <span className="session-count"><Icon type="caret-down" /> 10%</span></b>
				</Col>
				<Col span={4} className="text-center border-right">
					<h5 className="text-muted mb-3">MEDIA GROSS PROFIT</h5>
					<b className="text-dark">107, 165, 670 <span className="session-count"><Icon type="line" /> 0%</span></b>
				</Col>
			...
			<Row gutter="30" className="d-flex pt-4 mb-4">
				<Col span={8}><h3 className="mb-0">Scenario Data</h3></Col>
